...
from crdata.store import SeenKeys, append_battles, load_cohort, save_cohort
...
def main() -> int:
    ...
    cohort = load_cohort()
    if cohort.empty:
        print("Cohort is empty. Run scripts/seed_cohort.py first.")
        return 1
